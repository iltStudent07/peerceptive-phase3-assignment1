...
I found the use of Copilot to be very helpful in reinforcing core concepts of what I am learning in class. I learn through doing something and working it out in my head piece by piece. AI helps with this by allowing me to ask questions about concepts or pieces of code and get immediate feedback as well as being able to critique me whenever I try to code a new concept. AI also greatly helps with the debugging process as it saves a whole lot of time to ask Copilot if it can determine and explain  why a piece of code isn't working the way I want it to or why its not working at all. The main thing I've been learning about AI over the time in this class and doing this project is that you need to be very targeted in your prompts. AI will make a lot of assumptions in its output and its up to the programmer to steer its assumptions on the correct path or to give enough of a targeted prompt that it makes very little assumption to begin with. For instance I noticed that if Copilot detects that you are trying to program a certain pattern in your project (CRUD for instance), it will just go ahead and try to add code for the rest of the pattern that is missing even if that doesn't have anything to do with what you prompted it to do.
